...
If two or more players are tied for first place, the tied player with the **smallest** Neighborhood (i.e. fewest Plans) wins. If there is still a tie, the tied player with the **most** \[Mint\] wins. Still tied? You all win!
